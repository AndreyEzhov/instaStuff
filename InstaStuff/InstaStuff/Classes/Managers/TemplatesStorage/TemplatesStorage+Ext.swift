...
extension TemplatesStorage {
    ...
    func fillCoreData() {
        ...
        let CDItemFetch: NSFetchRequest<CDItem> = CDItem.fetchRequest()
        let CDItemInTemplateFetch: NSFetchRequest<CDItemInTemplate> = CDItemInTemplate.fetchRequest()
        let CDPhotoItemFetch: NSFetchRequest<CDPhotoItem> = CDPhotoItem.fetchRequest()
        let CDPhotoItemInTemplateFetch: NSFetchRequest<CDPhotoItemInTemplate> = CDPhotoItemInTemplate.fetchRequest()
        let CDPhotoItemSettingsFetch: NSFetchRequest<CDPhotoItemSettings> = CDPhotoItemSettings.fetchRequest()
        let CDSetFetch: NSFetchRequest<CDSet> = CDSet.fetchRequest()
        let CDSettingsFetch: NSFetchRequest<CDSettings> = CDSettings.fetchRequest()
    ...
    func set1template1() -> CDTemplate {
        let itemInTemplate = emptyFrameItemSettings(ratioX: 82.0, ratioY: 160.0, centerX: 54, centerY: 96)
